                    ...
                    <table id="myTable" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">สถานะของกุญแจ</th>
                                <th scope="col">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
                            $query = "SELECT * FROM sci_key";
                            $query_run = mysqli_query($conn, $query);

                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $keyall) {
                        ?>
                                <tr>
                                    <td><?= $keyall['key_number']; ?></td>
                                    <td><?= $keyall['key_floor']; ?></td>
                                    <td><?= $keyall['key_status']; ?></td>
                                    <td>
                                    <a href="edit_keys.php?id=<?= $keyall['id']; ?>" class="btn btn-primary">Edit</a>
